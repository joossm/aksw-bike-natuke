            ...
            for iteration in range(10):
                for dynamic_stage in dynamic_stages:
                    restored_df = pd.read_csv(
                        "{}results/{}_{}_{}_{}_{}_{}.csv".format(path, file_name, algorithm, split, edge_group,
                                                                 iteration, dynamic_stage))
...
hitsatk_df_mean = hitsatk_df.groupby(by=['k', 'algorithm', 'split', 'edge_group', 'dynamic_stage'],
                                     as_index=False).mean()
